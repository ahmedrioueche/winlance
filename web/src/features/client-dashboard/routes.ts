...
export const clientDashboardRoutes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        path: 'settings',
        name: 'client-workspace-settings',
        component: () => import('./components/pages/ClientSettingsPage.vue'),
        meta: { layout: 'blank', requiresAuth: true, titleKey: 'clients.nav.settings' },
      },
    ],
  },
]
